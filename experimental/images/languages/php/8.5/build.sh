...
apt-get update && \
    ...
    apt-get update && \
    apt-get install -y php8.5 php8.5-cli php8.5-common php8.5-xml php-pear php8.5-mbstring php-pgsql php-mysql php-mongo php-redis && \
    update-alternatives --install /usr/bin/php php /usr/bin/php8.5 100 && \
