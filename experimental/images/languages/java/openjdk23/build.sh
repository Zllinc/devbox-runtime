...
wget https://download.java.net/openjdk/jdk23/ri/openjdk-23+37_linux-x64_bin.tar.gz && \
    mkdir -p /usr/lib/jvm && \
    tar -xvf openjdk-23+37_linux-x64_bin.tar.gz -C /usr/lib/jvm && \
    mv /usr/lib/jvm/jdk-23 /usr/lib/jvm/java-23-openjdk-amd64 && \
    rm -f openjdk-23+37_linux-x64_bin.tar.gz
