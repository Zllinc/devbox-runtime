...
wget https://download.java.net/openjdk/jdk25/ri/openjdk-25+36_linux-x64_bin.tar.gz && \
    mkdir -p /usr/lib/jvm && \
    tar -xvf openjdk-25+36_linux-x64_bin.tar.gz -C /usr/lib/jvm && \
    mv /usr/lib/jvm/jdk-25 /usr/lib/jvm/java-25-openjdk-amd64 && \
    rm -f openjdk-25+36_linux-x64_bin.tar.gz
