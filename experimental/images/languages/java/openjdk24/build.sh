...
wget https://download.java.net/openjdk/jdk24/ri/openjdk-24+36_linux-x64_bin.tar.gz && \
    mkdir -p /usr/lib/jvm && \
    tar -xvf openjdk-24+36_linux-x64_bin.tar.gz -C /usr/lib/jvm && \
    mv /usr/lib/jvm/jdk-24 /usr/lib/jvm/java-24-openjdk-amd64 && \
    rm -f openjdk-24+36_linux-x64_bin.tar.gz
